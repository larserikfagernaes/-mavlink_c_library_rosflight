...
#define MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_MIN_LEN 8
#define MAVLINK_MSG_ID_199_LEN 8
#define MAVLINK_MSG_ID_199_MIN_LEN 8
                               ...
                               float battery_voltage, float battery_current)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_LEN, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_CRC);
}
                                   ...
                                   float battery_voltage,float battery_current)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_LEN, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_CRC);
}
...
static inline void mavlink_msg_rosflight_battery_status_send(mavlink_channel_t chan, float battery_voltage, float battery_current)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS, buf, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_LEN, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_CRC);
#else
    mavlink_rosflight_battery_status_t packet;
    packet.battery_voltage = battery_voltage;
    packet.battery_current = battery_current;

    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS, (const char *)&packet, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_LEN, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_rosflight_battery_status_send_struct(mavlink_channel_t chan, const mavlink_rosflight_battery_status_t* rosflight_battery_status)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_rosflight_battery_status_send(chan, rosflight_battery_status->battery_voltage, rosflight_battery_status->battery_current);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS, (const char *)rosflight_battery_status, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_LEN, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_LEN? msg->len : MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_LEN;
        memset(rosflight_battery_status, 0, MAVLINK_MSG_ID_ROSFLIGHT_BATTERY_STATUS_LEN);
    memcpy(rosflight_battery_status, _MAV_PAYLOAD(msg), len);
#endif
}
