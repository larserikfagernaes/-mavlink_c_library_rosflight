...
#define MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_MIN_LEN 16
                               ...
                               float qw, float qx, float qy, float qz)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_MIN_LEN, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_LEN, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_CRC);
}
                                   ...
                                   float qw,float qx,float qy,float qz)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_EXTERNAL_ATTITUDE;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_MIN_LEN, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_LEN, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_CRC);
}
...
static inline void mavlink_msg_external_attitude_send(mavlink_channel_t chan, float qw, float qx, float qy, float qz)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE, buf, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_MIN_LEN, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_LEN, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_CRC);
#else
    mavlink_external_attitude_t packet;
    packet.qw = qw;
    packet.qx = qx;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE, (const char *)&packet, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_MIN_LEN, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_LEN, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_external_attitude_send_struct(mavlink_channel_t chan, const mavlink_external_attitude_t* external_attitude)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_external_attitude_send(chan, external_attitude->qw, external_attitude->qx, external_attitude->qy, external_attitude->qz);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE, (const char *)external_attitude, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_MIN_LEN, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_LEN, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_LEN? msg->len : MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_LEN;
        memset(external_attitude, 0, MAVLINK_MSG_ID_EXTERNAL_ATTITUDE_LEN);
    memcpy(external_attitude, _MAV_PAYLOAD(msg), len);
#endif
}
