...
#define MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_MIN_LEN 64
#define MAVLINK_MSG_ID_190_LEN 64
#define MAVLINK_MSG_ID_190_MIN_LEN 64
                               ...
                               uint64_t stamp, const float *values)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_LEN, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_CRC);
}
                                   ...
                                   uint64_t stamp,const float *values)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_LEN, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_CRC);
}
...
static inline void mavlink_msg_rosflight_output_raw_send(mavlink_channel_t chan, uint64_t stamp, const float *values)
{
    ...
    _mav_put_uint64_t(buf, 0, stamp);
    _mav_put_float_array(buf, 8, values, 14);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW, buf, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_LEN, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_CRC);
#else
    mavlink_rosflight_output_raw_t packet;
    packet.stamp = stamp;
    mav_array_memcpy(packet.values, values, sizeof(float)*14);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW, (const char *)&packet, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_LEN, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_rosflight_output_raw_send_struct(mavlink_channel_t chan, const mavlink_rosflight_output_raw_t* rosflight_output_raw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_rosflight_output_raw_send(chan, rosflight_output_raw->stamp, rosflight_output_raw->values);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW, (const char *)rosflight_output_raw, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_LEN, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_LEN? msg->len : MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_LEN;
        memset(rosflight_output_raw, 0, MAVLINK_MSG_ID_ROSFLIGHT_OUTPUT_RAW_LEN);
    memcpy(rosflight_output_raw, _MAV_PAYLOAD(msg), len);
#endif
}
